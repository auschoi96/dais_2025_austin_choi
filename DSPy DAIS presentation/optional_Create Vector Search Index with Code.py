...
# MAGIC %md
# MAGIC #OPTIONAL Create Vector Indexes
# MAGIC
# MAGIC Reminder, you can always create this through the UI based on the delta table you created in the earlier notebook
